                            ...
                            <div>
                                <div class="d-flex align-items-center mb-3">
                                    <div class="avatar me-3">
                                        <img src="{{ asset(FrontHelper::getEnvFolder() . 'storage/back/assets/images/user/women_avatar5.jpg') }}" class="rounded-circle"
                                            alt="image">
                                    </div>
                                    <div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-custom mb-0" id="recent-products">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#">
                                            <img src="{{ asset(FrontHelper::getEnvFolder() . 'storage/back/assets/images/products/10.jpg') }}" class="rounded" width="40"
                                                alt="...">
                                        </a>
                                    </td>
                                    <td>Cookie</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#">
                                            <img src="{{ asset(FrontHelper::getEnvFolder() . 'storage/back/assets/images/products/7.jpg') }}" class="rounded" width="40"
                                                alt="...">
                                        </a>
                                    </td>
                                    <td>Glass</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#">
                                            <img src="{{ asset(FrontHelper::getEnvFolder() . 'storage/back/assets/images/products/8.jpg') }}" class="rounded" width="40"
                                                alt="...">
                                        </a>
                                    </td>
                                    <td>Headphone</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#">
                                            <img src="{{ asset(FrontHelper::getEnvFolder() . 'storage/back/assets/images/products/9.jpg') }}" class="rounded" width="40"
                                                alt="...">
                                        </a>
                                    </td>
                                    <td>Perfume</td>
