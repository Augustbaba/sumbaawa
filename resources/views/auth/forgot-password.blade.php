...
<head>
    ...
    <title>{{ FrontHelper::getAppName() }} - Mot de passe oublié?</title>
                        ...
                        <div class="row">
                            <div class="col-md-10 offset-md-1">
                                ...
                                <div class="my-5 text-center text-lg-start">
                                    <h1 class="display-8">Mot de passe oublié!!!</h1>
                                ...
                                <form class="mb-5" method="POST" action="{{ route('password.email') }}">
                                    ...
                                    <div class="text-center text-lg-start">
                                        <button class="btn btn-primary">Recevoir un lien de réinitialisation</button>
                                    </div>
                                </form>
