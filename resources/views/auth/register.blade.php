                ...
                <div class="row g-0">
                        ...
                        <div class="row">
                            <div class="col-md-10 offset-md-1">
                                ...
                                <form class="mb-5" method="POST" action="{{ route('register') }}">
                                    @csrf
                                    <div class="mb-3">
                                        <input type="text" name="name" class="form-control" value="{{ old('name') }}" placeholder="Entrer votre nom & prénom(s)" autofocus required>
                                        @error('name')
                                ...
                                <div class="social-links justify-content-center">
                                    <a href="#">
                                        <i class="ti-google bg-google"></i> S'inscrire avec Google
                                    </a>
                                    <a href="#">
                                        <i class="ti-facebook bg-facebook"></i> S'inscrire avec Facebook
                                    </a>
                                </div>
                                <p class="text-center d-block d-lg-none mt-5 mt-lg-0">
                                    Avez-vous un compte? <a href="{{ route('login') }}">Se Connecter</a>.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col d-none d-lg-flex border-start align-items-center justify-content-between flex-column text-center">
                        ...
                        <div>
                            ...
                            <p class="lead my-5">Avez-vous déjà un compte?</p>
