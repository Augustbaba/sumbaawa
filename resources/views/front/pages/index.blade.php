                                    ...
                                    <div>
                                        <div class="basic-product theme-product-1">
                                            <div class="overflow-hidden">
                                                <div class="img-wrapper">
                                                    <a href="product-page(image-swatch).html">
                                                        <img src="{{ asset(FrontHelper::getEnvFolder() . 'storage/front/assets/images/fashion-1/product/5.jpg') }}"
                                                            class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                    ...
                                    <div>
                                        <div class="basic-product theme-product-1">
                                            <div class="overflow-hidden">
                                                <div class="img-wrapper">
                                                    <a href="product-page(accordian).html"><img
                                                            src="{{ asset(FrontHelper::getEnvFolder() . 'storage/front/assets/images/fashion-1/product/6.jpg') }}"
                                                            class="img-fluid blur-up lazyload" alt=""></a>
                                    ...
                                    <div>
                                        <div class="basic-product theme-product-1">
                                            <div class="overflow-hidden">
                                                <div class="img-wrapper">
                                                    <a href="product-page(accordian).html"><img
                                                            src="{{ asset(FrontHelper::getEnvFolder() . 'storage/front/assets/images/fashion-1/product/7.jpg') }}"
                                                            class="img-fluid blur-up lazyload" alt=""></a>
                                                    <div class="rating-label"><i class="ri-star-s-fill"></i>
                                                        <span>4.5</span>
                                                    </div>
                                                ...
                                                <div class="product-detail">
                                                    <div>
                                                        <div class="brand-w-color">
                                                            <a class="product-title"
                                                                href="product-page(accordian).html">Urban Chic</a>
                                                            <div class="color-panel">
                                                                <ul>
                                                                    <li style="background-color: papayawhip;"></li>
                                                                    <li style="background-color: burlywood;"></li>
                                    ...
                                    <div>
                                        <div class="basic-product theme-product-1">
                                            <div class="overflow-hidden">
                                                <div class="img-wrapper">
                                                    <a href="product-page(accordian).html"><img
                                                            src="{{ asset(FrontHelper::getEnvFolder() . 'storage/front/assets/images/fashion-1/product/8.jpg') }}"
                                                            class="img-fluid blur-up lazyload" alt=""></a>
                                                    <div class="rating-label"><i class="ri-star-s-fill"></i>
                                                        <span>4.5</span>
                                                    </div>
                                    ...
                                    <div>
                                        <div class="basic-product theme-product-1">
                                            <div class="overflow-hidden">
                                                <div class="img-wrapper">
                                                    <a href="product-page(image-swatch).html">
                                                        <img src="{{ asset(FrontHelper::getEnvFolder() . 'storage/front/assets/images/fashion-1/product/9.jpg') }}"
                                                            class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                                    <div class="rating-label"><i
                                                            class="ri-star-fill"></i><span>4.5</span>
                                    ...
                                    <div>
                                        <div class="basic-product theme-product-1">
                                            <div class="overflow-hidden">
                                                <div class="img-wrapper">
                                                    <a href="product-page(accordian).html"><img
                                                            src="{{ asset(FrontHelper::getEnvFolder() . 'storage/front/assets/images/fashion-1/product/10.jpg') }}"
                                                            class="img-fluid blur-up lazyload" alt=""></a>
                                                    <div class="rating-label"><i class="ri-star-s-fill"></i>
                                                        <span>4.5</span>
                                                    </div>
                                    ...
                                    <div>
                                        <div class="basic-product theme-product-1">
                                            <div class="overflow-hidden">
                                                <div class="img-wrapper">
                                                    <a href="product-page(accordian).html"><img
                                                            src="{{ asset(FrontHelper::getEnvFolder() . 'storage/front/assets/images/fashion-1/product/12.jpg') }}"
                                                            class="img-fluid blur-up lazyload" alt=""></a>
                                                    <div class="rating-label"><i class="ri-star-s-fill"></i>
                                                        <span>4.5</span>
                                                    </div>
                                    ...
                                    <div>
                                        <div class="basic-product theme-product-1">
                                            <div class="overflow-hidden">
                                                <div class="img-wrapper">
                                                    <a href="product-page(image-swatch).html">
                                                        <img src="{{ asset(FrontHelper::getEnvFolder() . 'storage/front/assets/images/fashion-1/product/13.jpg') }}"
                                                            class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                                    <div class="rating-label"><i
                                                            class="ri-star-fill"></i><span>4.5</span>
                                    ...
                                    <div>
                                        <div class="basic-product theme-product-1">
                                            <div class="overflow-hidden">
                                                <div class="img-wrapper">
                                                    <a href="product-page(accordian).html"><img
                                                            src="{{ asset(FrontHelper::getEnvFolder() . 'storage/front/assets/images/fashion-1/product/14.jpg') }}"
                                                            class="img-fluid blur-up lazyload" alt=""></a>
                                                    <div class="rating-label"><i class="ri-star-s-fill"></i>
                                                        <span>4.5</span>
                                                    </div>
                    ...
                    <div class="slide-3 no-arrow slick-default-margin">
                        <div class="col-md-12">
                            <a href="#!">
                                <div class="classic-effect">
                                    <div>
                                        <img src="{{ asset(FrontHelper::getEnvFolder() . 'storage/front/assets/images/fashion-1/blog/1.png') }}"
                        ...
                        <div class="col-md-12">
                            <a href="#!">
                                <div class="classic-effect">
                                    <div>
                                        <img src="{{ asset(FrontHelper::getEnvFolder() . 'storage/front/assets/images/fashion-1/blog/2.png') }}"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                                    <span></span>
                                </div>
                        ...
                        <div class="col-md-12">
                            <a href="#!">
                                <div class="classic-effect">
                                    <div>
                                        <img src="{{ asset(FrontHelper::getEnvFolder() . 'storage/front/assets/images/fashion-1/blog/3.png') }}"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                                    <span></span>
                                </div>
            ...
            <div class="row">
                <div class="col-md-12 p-0">
                    ...
                    <div class="slide-7 no-arrow slick-instagram">
                        <div>
                            <a href="#!">
                                <div class="instagram-box"> <img src="{{ asset(FrontHelper::getEnvFolder() . 'storage/front/assets/images/fashion-1/instagram/1.png') }}"
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box"> <img src="{{ asset(FrontHelper::getEnvFolder() . 'storage/front/assets/images/fashion-1/instagram/2.png') }}"
                                        class="bg-img" alt="img">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box"> <img src="{{ asset(FrontHelper::getEnvFolder() . 'storage/front/assets/images/fashion-1/instagram/3.png') }}"
                                        class="bg-img" alt="img">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box"> <img src="{{ asset(FrontHelper::getEnvFolder() . 'storage/front/assets/images/fashion-1/instagram/4.png') }}"
                                        class="bg-img" alt="img">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box"> <img src="{{ asset(FrontHelper::getEnvFolder() . 'storage/front/assets/images/fashion-1/instagram/5.png') }}"
                                        class="bg-img" alt="img">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box"> <img src="{{ asset(FrontHelper::getEnvFolder() . 'storage/front/assets/images/fashion-1/instagram/6.png') }}"
                                        class="bg-img" alt="img">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#!">
                                <div class="instagram-box"> <img src="{{ asset(FrontHelper::getEnvFolder() . 'storage/front/assets/images/fashion-1/instagram/7.png') }}"
                                        class="bg-img" alt="img">
                                    <div class="overlay"><i class="ri-instagram-fill"></i></div>
                                </div>
                            </a>
                    ...
                    <div class="slide-6 no-arrow">
                        <div>
                            <div class="logo-block">
                                <a href="#!"><img src="{{ asset(FrontHelper::getEnvFolder() . 'storage/front/assets/images/logos/1.png') }}" alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
                                <a href="#!"><img src="{{ asset(FrontHelper::getEnvFolder() . 'storage/front/assets/images/logos/2.png') }}" alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
                                <a href="#!"><img src="{{ asset(FrontHelper::getEnvFolder() . 'storage/front/assets/images/logos/3.png') }}" alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
                                <a href="#!"><img src="{{ asset(FrontHelper::getEnvFolder() . 'storage/front/assets/images/logos/4.png') }}" alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
                                <a href="#!"><img src="{{ asset(FrontHelper::getEnvFolder() . 'storage/front/assets/images/logos/5.png') }}" alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
                                <a href="#!"><img src="{{ asset(FrontHelper::getEnvFolder() . 'storage/front/assets/images/logos/6.png') }}" alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
                                <a href="#!"><img src="{{ asset(FrontHelper::getEnvFolder() . 'storage/front/assets/images/logos/7.png') }}" alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
                                <a href="#!"><img src="{{ asset(FrontHelper::getEnvFolder() . 'storage/front/assets/images/logos/8.png') }}" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>
