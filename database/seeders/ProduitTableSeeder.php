...
class ProduitTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Produit::create([
            ...
            'image_main' => FrontHelper::getEnvFolder() .'produits/p33.jpg',
            'color' => 'Chêne',
            'niveau_confort' => null,
            'poids' => 20.00,
        ...
        Produit::create([
            ...
            'image_main' => FrontHelper::getEnvFolder() .'produits/p34.jpg',
            'color' => 'Blanc',
            'niveau_confort' => null,
            'poids' => 10.00,
            'sous_categorie_id' => 17,
        ...
        Produit::create([
            ...
            'image_main' => FrontHelper::getEnvFolder() .'produits/p35.jpg',
            'color' => 'Noir',
            'niveau_confort' => null,
            'poids' => 2.50,
        ...
        Produit::create([
            ...
            'image_main' => FrontHelper::getEnvFolder() .'produits/p36.jpg',
            'color' => 'Gris',
            'niveau_confort' => null,
            'poids' => 1.00,
            'sous_categorie_id' => 18,
